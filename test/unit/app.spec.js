describe('app', function () {
    ...
    describe('assignToSwimmingCourse', function () {
        ...
        it('should assign person between the ages of 12 - 17 to teens group', function () {
            ...
            expect(app.assignToSwimmingCourse('Stefan', '07/10/2002')).toEqual({
                name: 'Stefan', age: 13, course: 'teens'
            });
        });
        iit('should assign person below 12 to kids group', function () {
            expect(app.assignToSwimmingCourse('Zack', '10/06/2010')).toEqual({
                name: 'Zack', age: 5, course: 'kids'
            });
            expect(app.assignToSwimmingCourse('Zenek', '10/06/2010')).toEqual({
                name: 'Zenek', age: 5, course: 'kids'
            });

        });
        it('should should should ...',function(){});
    });
